...
if (!$showMessage && isset($_POST['md']) && $_POST['md'] === 'grave') {
    $dblink = DbConnect();
    $sql = 'INSERT INTO grave (fname, lname, mname, dt1, dt2, idtadd, idxadd, idxkladb) VALUES ("' .
        $_POST['fname'] . '","' .
        $_POST['lname'] . '","' .
        $_POST['mname'] . '","' .
        $_POST['dt1'] . '","' .
    ...
    $out = '<div class="contentgrave-form">
        <form action="graveadd.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-content" style="padding:24px;padding-top:15px;padding-bottom:15px;">
                ...
                <div class="form-row-grave dates">
                    <div class="input-container-grave">
                        <input type="date" name="dt1" required>
                        <label>Дата народження *</label>
                    </div>
                    <div class="input-container-grave">
                        <input type="date" name="dt2" required>
        ...
        '<label>Область *</label>
                ...
                <div class="form-row-grave cemetery">
                    <div class="input-container-grave">
                        <input type="text" name="idxkladb" required placeholder=" ">
